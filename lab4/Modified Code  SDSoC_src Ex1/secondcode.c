...
//#pragma HLS ARRAY_PARTITION variable=W1 cyclic factor=30 dim=1
//#pragma HLS ARRAY_PARTITION variable=W3 cyclic factor=50 dim=1
...
#pragma HLS ARRAY_PARTITION variable=xbuf block factor=49 dim=1
